...
function registerNetxTools(ctx, connection, options) {
  ...
  const catalog = [
    ...
    tool2("netx__listBizMonitors", "Catalog: list cutover/monitor-compare projects and biz_state monitor tasks. No project_id needed — call this first when the user did not give an id, then use getBizMonitorContext.", {
