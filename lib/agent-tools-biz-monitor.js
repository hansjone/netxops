...
function registerNetxTools(ctx, connection, options) {
  ...
  const catalog = [
    ...
    tool2("netx__getBizMonitorContext", "Biz-monitor definition bundle: cutover project + monitor/compare templates + iface normalize + port mapping + related tasks/commands. Prefer project_id. Display keys are device-raw A/B.", {
