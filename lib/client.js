            ...
            children: [
              /* @__PURE__ */ jsx_runtime.jsxs("div", {
                ...
                children: [
                  ...
                  state.alarmPushEnabled.overridden ? /* @__PURE__ */ jsx_runtime.jsxs("span", {
                    className: "dsh-nx-badges",
                    children: [
                      /* @__PURE__ */ jsx_runtime.jsx("span", {
                        className: "dsh-nx-badge",
...
class NetxopsCardController {
  ...
  constructor(scope, ctx) {
    this.scope = scope;
    this.ctx = ctx;
    this.form = new CardForm(scope, [textField("apiUrl"), textField("lang"), booleanField("alarmPushEnabled")], [{ field: API_TOKEN_FIELD, write: (text) => this.writeToken(text) }]);
